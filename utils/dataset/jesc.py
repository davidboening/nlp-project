...
class JESCDataset:
    ...
    def create_csv(force_override=False):
        ...
        output_path = f"{DatasetConfig.DATASET_PROCESSED_DIR}/{DatasetConfig.JESC_OUT_NAME}"
        ...
        with open(output_path, "wb+") as csv_file:
            ...
            with tarfile.open(f"{DatasetConfig.DATASET_RAW_DIR}/JESC/raw.tar.gz", mode="r") as tfh:
